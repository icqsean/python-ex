...
a = batch_move_and_rename(path+"/Excel1", d_path, "a_")
b = batch_move_and_rename(path+"/Excel2", d_path, "b_")        
c = batch_move_and_rename(path+"/Excel3", d_path, "c_")
d = batch_move_and_rename(path+"/Excel4", d_path, "d_")
shutil.rmtree(path)
